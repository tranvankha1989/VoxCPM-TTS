...
Write-Host "  https://github.com/tranvankha1989/VoxCPM-TTS.git" -ForegroundColor Cyan
Write-Host "===================================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  https://github.com/tranvankha1989/VoxCPM-TTS" -ForegroundColor Green
    Write-Host "===================================================================" -ForegroundColor Green
} else {
    Write-Host ""
